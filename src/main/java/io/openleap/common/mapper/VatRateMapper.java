...
public interface VatRateMapper {
    ...
    VatRateEO toEntity(VatRate dto);

    VatRate toDto(VatRateEO entity);

    List<VatRate> toDtoList(List<VatRateEO> entities);
    List<VatRateEO> toEntityList(List<VatRate> dtos);
}